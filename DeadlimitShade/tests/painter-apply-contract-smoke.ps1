...
Assert-True $plugin.Contains('substance_painter.display.set_environment_resource') 'Apply must activate the retail Default environment without manual shelf work.'
...
Assert-True $heroShader.Contains('float ambientOcclusion = dlSampleWithFallback(') 'Deadlock consumers must receive resolved Artistic AO.'
