...
Assert-Contains 'internal/src/Deadlimit/App/SettingsForm.cs' 'UiText.T("OPEN GOOGLE DRIVE", "ОТКРЫТЬ GOOGLE DRIVE")'
Assert-Contains 'internal/src/Deadlimit/App/SettingsForm.cs' 'UiText.T("FINE-TUNE CSDK", "ДОНАСТРОИТЬ CSDK")'
Assert-Contains 'internal/src/Deadlimit/App/SettingsForm.cs' 'UiText.T("LATER", "ПОЗЖЕ")'
Assert-Contains 'internal/src/Deadlimit/App/SettingsForm.cs' 'CsdkSetupPulsePeriodSeconds = 1.4'
Assert-Contains 'internal/src/Deadlimit/App/SettingsForm.cs' 'ToolchainDependencyService.IsCsdkSetupCurrentForCurrentGuide(root)'
Assert-Contains 'internal/src/Deadlimit/Core/ToolchainDependencyService.cs' 'arguments.Add("-qr");'
Assert-Contains 'internal/src/Deadlimit/Core/ToolchainDependencyService.cs' 'arguments.Add("-remember-password");'
Assert-Contains 'internal/src/Deadlimit/Core/ToolchainDependencyService.cs' 'arguments.AddRange(depots.Select(depot => depot.DepotId));'
Assert-Contains 'internal/src/Deadlimit/Localization/zh-CN.json' '"FINE-TUNE CSDK": "完善 CSDK 配置"'
Assert-Contains 'internal/src/Deadlimit/Localization/pt-BR.json' '"FINE-TUNE CSDK": "AJUSTAR CSDK"'
Assert-Contains 'internal/src/Deadlimit/Localization/zh-CN.json' '"OPEN GOOGLE DRIVE": "打开 GOOGLE DRIVE"'
Assert-Contains 'internal/src/Deadlimit/Localization/pt-BR.json' '"OPEN GOOGLE DRIVE": "ABRIR GOOGLE DRIVE"'
Assert-Contains 'internal/src/Deadlimit/Localization/zh-CN.json' '"Could not open Google Drive"'
Assert-Contains 'internal/src/Deadlimit/Localization/pt-BR.json' '"Could not open Google Drive"'
...
Assert-Contains 'internal/src/Deadlimit/App/SettingsVersionFeature.cs' 'MainCommitApiUrl'
Assert-Contains 'internal/src/Deadlimit/App/SettingsVersionFeature.cs' 'CurrentDisplayIdentity() => "main"'
Assert-Contains 'internal/src/Deadlimit/App/SettingsVersionFeature.cs' 'Path.Combine(updateRoot, "Update Deadlimit.cmd")'
Assert-NotContains 'internal/src/Deadlimit/App/SettingsVersionFeature.cs' 'latest-main'
Assert-NotContains 'internal/src/Deadlimit/App/SettingsVersionFeature.cs' 'ReleaseChannelPolicy'
