...
foreach ($required in @(
    ...
    'Install-Deadlimit-error.log',
    'Start-Transcript -LiteralPath $sessionLogPath',
...
foreach ($retired in @(
    ...
    'Windows Package Manager (WinGet) was not found. Install Microsoft App Installer / WinGet, then run Install-Deadlimit.cmd again.',
