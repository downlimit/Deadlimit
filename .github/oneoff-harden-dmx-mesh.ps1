...
$replacements = @(
    ...
    @('                            meshop.setNumMapFaces editableObject 0 snapshot[4].count keep:false' + "`r`n", ''),
    @('                            meshop.setNumMapFaces editableObject 0 snapshot[4].count keep:false' + "`n", ''),
    ...
    @('                meshop.setNumMapFaces editableObject 0 faceCount keep:false' + "`r`n", ''),
    @('                meshop.setNumMapFaces editableObject 0 faceCount keep:false' + "`n", '')
)
